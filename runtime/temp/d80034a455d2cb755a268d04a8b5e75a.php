...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
            ...
            <div class="col-md-9">
                ...
                <div class="form-group">
                    <label for="username" class="col-sm-3 control-label">
                        <span class="red-color">*</span>上传图片：
                    </label>

                    <div class="col-sm-9">
                        <input type="file" onchange="uploadFiles()" style="display:none;" class="form-control form-control-sm" id="file" />
                        <img id="imgs" src="<?php echo (isset($info['imgs']) && ($info['imgs'] !== '')?$info['imgs']:''); ?>" style="width:90px;height:80px;">
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary edit_save" type="button"  data-url="<?php echo url('/v1/charts/chart/edit'); ?>" data-id="<?php echo $info['id']; ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
